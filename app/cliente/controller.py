...
class ClienteLogin(MethodView):
    def post(self):
        ...
        return {"senha":f'{senha}', "senha_inserida_hash":f'{senha_inserida_hasheada}', "senha_cliente_hash":f'{cliente.senha_hash}',"decode":f'{senha_inserida_hasheada.decode()}', "senha_encode":senha.encode()}
